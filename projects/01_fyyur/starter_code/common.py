...
# Changed states to be consistent with phone_dict
class STATES(Enum):
    AL = 'AL'
    AK = 'AK'
    AS = 'AS'
...
phone_dict = {
    ...
    "AR": [479, 501, 870],
    "CA": [209, 213, 310, 323, 408, 415, 424, 442, 510, 530, 559, 562, 619, 626, 650, 657, 661, 669, 707, 714,
    ...
    "TX": [210, 214, 254, 281, 325, 346, 361, 409, 430, 432, 469, 512, 682, 713, 737, 806, 817, 830, 832, 903,
...
merged = [(genre.name, genre.value) for genre in GENRES]
